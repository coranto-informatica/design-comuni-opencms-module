	...
	<cms:bundle basename="it.coranto.comuni.messages">
		...
		<body>
			...
			<main>
				...
				<%@ include file="%(link.strong:/system/modules/it.coranto.comuni/elements/searchbar.jsp:e58a4fa0-564e-11f0-b07a-1b1fd91899eb)" %>
				<%@ include file="%(link.strong:/system/modules/it.coranto.comuni/elements/searchresults.jsp:73f4982d-564f-11f0-b07a-1b1fd91899eb)" %>
